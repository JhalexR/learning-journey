...
classDef green fill:#D9EAD3,stroke:#6AA84F,color:#000;
classDef blue fill:#D0E0FF,stroke:#3D85C6,color:#000;
classDef yellow fill:#FFF2CC,stroke:#BF9000,color:#000;
