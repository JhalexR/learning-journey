...
Organizan la información en forma de árbol invertido, donde cada elemento (nodo) se conecta con otros mediante relaciones de subordinación o dependencia (padre e hijo).
