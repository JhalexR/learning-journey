...
4. Al aplicar el patrón (Pub/Sub) se solucionarían los problemas de "incoherencias en la información, duplicación de datos y demoras en el acceso resultados clínicos"
```
