...
D["Paciente intenta Agendar de cita el mismo día"]
...
```
Se crearían tres servicios:

1 Primer servicio de laboratorio (publicador)
2 Segundo servicio agendamiento de citas (suscriptor 1)
3 Tercer servicio historial médico (suscriptor 2)

4 En cuanto se emitan los resultados el Publicador enviaría un mensaje.

5 Los dos suscriptores actualizarían sus bases de datos con los resultados de laboratorio después de recibir el mensaje
```

_Al aplicar el patrón (Pub/Sub) se solucionarían los problemas de "incoherencias en la información, duplicación de datos y demoras en el acceso resultados clínicos"_
