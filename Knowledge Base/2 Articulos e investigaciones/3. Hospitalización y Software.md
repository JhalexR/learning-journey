...
_**¿Cómo podría diseñarse un sistema de información que ?**_

```mermaid
flowchart 

    A((facilite que las personas involucradas compartan información confiable y actualizada,))
    B((coordinen sus acciones ))
    C((puedan conocer qué ha ocurrido ))
    D((qué está pendiente por realizar?))  
